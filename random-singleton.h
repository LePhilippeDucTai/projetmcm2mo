...
class Random //Singleton
{
  ...
  public:
    ...
    static double LogNormal(double mean=0, double standardDeviation=1);
    static double Exponential(double lambda=1);

    static double PoissonCompLogN(double lambda, double mu=0, double sd=1);
